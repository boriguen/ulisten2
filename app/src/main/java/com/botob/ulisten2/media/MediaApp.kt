...
enum class MediaApp(private val packageName: String, private val mClass: Class<*>) {
    ANDROID_MUSIC("com.android.music", AndroidMusicMedia::class.java), DEEZER(
        "deezer.android.app",
        DeezerMedia::class.java
    ),
    GOOGLE_PLAY_MUSIC(
        "com.google.android.music",
        GooglePlayMusicMedia::class.java
    ),
    PANDORA("com.pandora.android", PandoraMedia::class.java), SPOTIFY(
        "com.spotify.music",
        SpotifyMedia::class.java
    );
